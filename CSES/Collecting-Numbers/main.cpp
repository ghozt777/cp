/*
    ...
    Time: Tue Jul 19 19:07:59 IST 2022
	Link to problem / contest : https://cses.fi/problemset/task/2216
*/
...
void solve(){
	...
	ll n;
	cin>>n;
	vector<ll> arr(n),idx(n);
	for(ll i=0;i<n;i++)cin>>arr[i],idx[arr[i]]=i;
	ll res=1;
	for(ll i=1;i<n;i++){
		res+=idx[i+1]<idx[i];
	}
