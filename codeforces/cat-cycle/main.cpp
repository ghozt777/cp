/*
    ...
    Time: Mon Jun 13 00:29:30 IST 2022
	Link to problem / contest : https://codeforces.com/gym/348180/problem/C
*/
...
void solve(){
	...
	--k ;
	if(n & 1){
		ll no_of_collisions = k / ((n - 1)/2) ;
		cout << 1 + (no_of_collisions + k)%n << endl ; 
	} else {
		cout << 1 + (k % n) << endl ;
	}
}
